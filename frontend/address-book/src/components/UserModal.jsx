        ...
        <div className="modal" onClick={() => setShowModal(false)}>
            <div className="modalContent" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    <input type="text" name="firstName" id="firstName" placeholder="First Name" value={userInfo.firstName} onChange={handleChange} disabled={modalEditableState} required/>
                    {errors.firstName ?
                    ...
                    <input type="text" name="lastName" id="lastName" placeholder="Last Name" value={userInfo.lastName} onChange={handleChange} disabled={modalEditableState} required/>

                    <label htmlFor="street1" className="sr-only">Street Address</label>
                    <input type="text" name="street1" id="street1" placeholder="Street Address" value={userInfo.street1} onChange={handleChange} disabled={modalEditableState} required/>

                    <label htmlFor="street2" className="sr-only">Street Address 2</label>
                    <input type="text" name="street2" id="street2" placeholder="Street Address 2" value={userInfo.street2} onChange={handleChange} disabled={modalEditableState}/>

                    <label htmlFor="city" className="sr-only">City</label>
                    <input type="text" name="city" id="city" placeholder="City" value={userInfo.city} onChange={handleChange} disabled={modalEditableState} required/>

                    <label htmlFor="state" className="sr-only">State</label>
                    <select name="state" id="state" value={userInfo.state} onChange={handleChange} disabled={modalEditableState} required>
                    ...
                    {userInfo._id ? (
                        <button className=""onClick={deleteUser} disabled={modalEditableState}>Delete</button>
                    ):null}
                    <button className="submitButton" disabled={modalEditableState}>Edit/Submit</button>
                </form>
            </div>
        </div>
    )
